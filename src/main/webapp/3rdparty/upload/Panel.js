		...
		return {
			...
			items: [
				...
				new Ext.form.TextField({
					...
					width: 130,
					margin: '15 5 0 5',
					emptyText: 'Upload Path',
					listeners: {
						change: function(textfield)
						{
							filepath = textfield.getValue();
							Ext.getCmp('uploadwindow').panel.uploadManager.uploader.url = appRoot + '/file?path=' + encodeURIComponent(filepath);
						}
					}
				}),
				'-',
